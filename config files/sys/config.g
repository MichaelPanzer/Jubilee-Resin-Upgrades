...
;-------------------------------------------------------------------------------
M584 X0.3 Y0.4            ; Map Corexy's X,Y axes
M584 U0.1                 ; Map U axis (toolchanger lock) 
M584 Z1.0:1.1:0.2         ; Map 3 axes for Z (front left, rear middle, front right) 


; Motor (Drive) Currents and Directions
;-------------------------------------------------------------------------------
M569 P0.3 S0              ; Flip 3HC Motor 0 (corexy a) direction
M569 P0.4 S0              ; Flip 3HC Motor 1 (corexy b) direction
...
M569 P1.0 S1              ; Flip Mainboard Motor 2 (Front Left Z) direction.
M569 P1.1 S1              ; Flip Mainboard Motor 2 (Back Z) direction.
M569 P0.2 S0              ; Flip Mainboard Motor 2 (Front Right Z) direction.
...
M574 Y1 S1 P"^0.io3.in"  ; 3HC Y homing position Y1 = axis min, S1 = switch type
...
M558 P8 C"io0.in" H9 F360 T6000 ; H = Z probe clearance height
                                ; F = probe speed
                                ; T = travel speed
...
; Dimensions are adjusted such that (0,0) lies at the lower left cornerof a centered 300x300mm square in the 305mmx305mm build plate.
...
; Tool definitions
M563 P0 S"Sonicator"; Define tool 0
G10 P0 Z-100                  ; Set tool 0 offset from the bed
