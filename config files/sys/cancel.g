...
;-------------------------------------------------------------------------------
M584 X0.4 Y0.3            ; Map Corexy's X,Y axes
...
;-------------------------------------------------------------------------------
M569 P0.4 S0              ; Flip 3HC Motor 0 (corexy a) direction
M569 P0.3 S1              ; Flip 3HC Motor 1 (corexy b) direction
...
M569 P1.0 S0              ; Flip Mainboard Motor 2 (Front Left Z) direction.
M569 P1.1 S1              ; Flip Mainboard Motor 2 (Front Right Z) direction.
M569 P0.2 S1              ; Flip Mainboard Motor 2 (Back Z) direction.
